                      ...
                      <div class="col-md-12">
                        <div class="white-panel pn">
                          <div class="panel-heading">
                            <div class="pull-left"><h3></i><h3> Grade 11 <i class="fa fa-angle-right"></i> Core Subjects</h3></div>
                            <br>
                          </div>
                          <?php foreach ($shs_cs_subj_g11 as $shs_cs_g11) {?>
