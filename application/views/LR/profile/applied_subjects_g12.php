                      ...
                      <div class="col-md-12">
                        <div class="white-panel pn">
                          <div class="panel-heading">
                            <div class="pull-left"><h3></i><h3> Grade 12 <i class="fa fa-angle-right"></i> Applied Subjects</h3></div>
                            <br>
                          </div>
                          <?php foreach ($shs_as_subj_g12 as $shs_as_g12) {?>
