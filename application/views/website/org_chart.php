...
<div class="tree">
  <div class = "one_third fl_left">
    <h6 class="org_heading">
      <i class="fa fa-sitemap"></i>
      Organizational Chart</h6>
  </div>
    <ul class="first" id="organization">
      <li><span class="box"><div class="avatar"></div><strong>Principal</strong></br>John Smith</span>
        <ul>
          <li>
            <ul>
            ...
            <ul>
              <li><span class="box"><div class="avatar"></div>Librarian-  <strong>Assistant</strong><br/>Hannah Patrcia Liao</span>
                <ul>
                  <li><span class="box"><div class="avatar"></div>Librarian-  <strong>Assistant</strong><br/>Hannah Patrcia Liao</span>
                    <ul>
                      <li><span class="box"><div class="avatar"></div>Librarian-  <strong>Assistant</strong><br/>Hannah Patrcia Liao</span></li>
                    </ul>
                  </li>
                </ul>
              </li>
