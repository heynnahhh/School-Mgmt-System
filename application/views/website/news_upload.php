...
<head>
  ...
  <title>WEBSITE | Pages | Home</title>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li>
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo site_url();?>/LRMDS/home"><i class="fa fa-circle-o"></i> Assessment and Evaluation</a></li>
                <li><a href="<?php echo site_url();?>/LRMDS/home"><i class="fa fa-circle-o"></i> Storage and Maintenance</a></li>
            ...
            <li>
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo site_url();?>/LRMDS/home"><i class="fa fa-circle-o"></i> Home</a></li>
                <li><a href="<?php echo site_url();?>/LRMDS/home"><i class="fa fa-circle-o"></i> Resources</a></li>
                <li><a href="<?php echo site_url();?>/LRMDS/home"><i class="fa fa-circle-o"></i> Media Gallery</a></li>
            ...
            <li>
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo site_url();?>/LRMDS/home"><i class="fa fa-circle-o"></i> User Management</a></li>
              </ul>
            </li>
          </ul>
        </li>
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li>
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo site_url();?>/#"><i class="fa fa-circle-o"></i> Search</a></li>
                <li><a href="<?php echo site_url();?>/#"><i class="fa fa-circle-o"></i> Stocks</a></li>
                <li><a href="<?php echo site_url();?>/#"><i class="fa fa-circle-o"></i> Expenses</a></li>
              </ul>
            </li>
            <li>
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="<?php echo site_url();?>/#"><i class="fa fa-circle-o"></i> Generate PBB</a></li>
              </ul>
            </li>
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="<?php echo site_url();?>/LRMDS/home"><i class="fa fa-circle-o"></i> Pages</a></li>
                <li><a href="<?php echo site_url();?>/LRMDS/home"><i class="fa fa-circle-o"></i> Widgets</a></li>
                <li><a href="<?php echo site_url();?>/LRMDS/home"><i class="fa fa-circle-o"></i> Forms</a></li>
              </ul>
            </li>
            <li><a href="<?php echo site_url();?>/INVENTORY/home"><i class="fa fa-circle-o"></i> Preview</a></li>
            <li><a href="<?php echo site_url();?>/INVENTORY/home"><i class="fa fa-circle-o"></i> Settings</a></li>
