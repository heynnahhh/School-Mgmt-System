...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="<?php echo base_url();?>/starter" class="logo">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Inventory <small>(Manage Records)</small>
      </h1>
      <ol class="breadcrumb">
        <li>MAIN NAVIGATION</li>
        <li><a href="<?php echo site_url();?>/INVENTORY/manage_records"><i class="fa fa-database"></i>INVENTORY</a></li>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h2 class="box-title">Items  &middot;<small>Below is a list of items.</small></h2>
