...
<head>
  ...
  <title>LIBRARY | Book(s) List</title>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo site_url();?>/LIBRARY/home/books_list"><i class="fa fa-circle-o"></i> Book(s) List</a></li>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <small>&middot;&nbsp;Below are the list of books</small>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  <td style="width:100px;"><img src="<?php echo base_url();?>/uploads/books/<?php echo $book->imageName;?>" width="100px" height="150px"></td>
                  <td><?php echo $book->book_isbn?></td>
                  <td><?php echo $book->book_title;?></td>
                  <td><?php echo $book->book_authors;?></td>
                  <td>
                    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#<?php echo $book->book_id;?>" value="<?php echo $book->book_id;?>"><i class="fa fa-eye"></i></button>
                    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#<?php echo $book->book_id;?>" value="<?php echo $book->book_id;?>"><i class="fa fa-edit"></i></button>
                  </td>
                  </tr>
                        ...
                        <div class="modal-body">
                          <form action="<?php echo site_url('LIBRARY/home/addbook')?>" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                            ...
                            <!-- <div class="form-group">
                              <img class="" src="<?php echo base_url();?>/uploads/books/<?php echo $book->imageName;?>" width="200px" height="250px"><h3>
                            </div>
                            <div class="form-group">
                              <input class="form control col-md-6" type="text"value="<?php echo $book->book_title;?>"></input>
                            </div>
                            <div class="form-group">
                              <div class="col-md-12">
                                <p><b>ISBN: </b><?php echo $book->book_isbn;?></p>
                                <p><b>Borrowed copies: </b>>>borrowers</p>
                                <p><b>Author: </b><?php echo $book->book_authors;?></p>
