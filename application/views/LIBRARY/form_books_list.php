            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td>
                    <button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#<?php echo $book->book_id;?>" value="<?php echo $book->book_id;?>"><i class="fa fa-eye"></i></button>
                  </td>
                  </tr>
                  <?php };?>
                </tbody>
