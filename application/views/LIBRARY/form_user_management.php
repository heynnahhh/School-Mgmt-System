        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="<?php echo site_url();?>/LIBRARY/home/book_users"><i class="fa fa-circle-o"></i> User Management</a></li>
              </ul>
            </li>
          </ul>
        </li>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <h2 class="box-title">Users &middot;&nbsp;<small>Below is a list of the users.</small></h2>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td>
                    <a href="edituser?id=<?php echo $user->id;?>" type="button" class="btn btn-info"><i class="fa fa-edit"></i></a>
