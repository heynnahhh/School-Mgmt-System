      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo site_url();?>/LIBRARY/home/returned_books"><i class="fa fa-circle-o"></i> Returned Book(s)</a></li>
            <li>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h2 class="box-title">Returned &middot; <small>Below is a list of returned books.</small></h2>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td><?php echo $return->book_authors;?></td>
                  <td><?php echo $return->borrow_status?></td>
