...
<head>
  ...
  <title>LIBRARY | Borrowed Book(s)</title>
      ...
      <ul class="sidebar-menu">
        ...
        <li class=" active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo site_url();?>/LIBRARY/home/borrowed_books"><i class="fa fa-circle-o"></i> Borrowed Book(s)</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?php echo site_url();?>/LIBRARY/home/borrowed_books">Borrowed Book(s)</a></li>
      </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h2 class="box-title">Requests &middot; <small>Below is a list of requested books.</small></h2>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td><?php echo $request->book_authors;?></td>
                  <td><?php echo $request->borrow_status;?></td>
                  <td><?php echo $request->date;?></td>
                  <td>
                    <a href="accept?id=<?php echo $request->request_id;?>&book_id=<?php echo $request->book_id;?>&users_id=<?php echo $request->users_id;?>" type="button" class="btn btn-info"><i class="fa fa-check"></i>&nbsp;&nbsp;Accept Request</a>
                  </td>
                </tr>
                <?php }?>
                </tbody>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h2 class="box-title">Borrowed &middot; <small>Below is a list of borrowed books.</small></h2>
              <div class="box-tools pull-right">
                <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                </button>
              </div>
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td><?php echo $book->borrow_status;?></td>
                  <td><?php echo $book->date_borrowed;?></td>
                  <td>
                    <a href="returnedbooks?id=<?php echo $book->book_id;?>" type="button" class="btn btn-info"><i class="fa fa-check"></i> Returned</a>
                  </td>
                </tr>
                <?php };?>
                </tbody>
